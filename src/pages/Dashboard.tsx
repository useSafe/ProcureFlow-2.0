    ...
    <div className="space-y-6 h-full overflow-auto pb-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3 items-center">
          ...
          <Button variant="outline" onClick={handleExportDashboard} className="bg-[#1e293b] border-slate-700 text-slate-300 hover:text-white">
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    <Pie data={statusData} cx="50%" cy="48%" innerRadius={50} outerRadius={80} paddingAngle={5} dataKey="value" stroke="none">
                      ...
                      <LabelList dataKey="value" position="outside" fill="#fff" stroke="none" fontSize={10} />
                    </Pie>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={hierarchyData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                              ...
                              <div className="space-y-1">
                                ...
                                {data.type === 'box' && (
                                  <p className="text-sm text-slate-300 flex items-center">
                                    ...
                                    Boxes: <span className="text-white font-bold ml-1">1</span>
                                  </p>
                                )}
                                {(data.type === 'drawer' && data.Boxes > 0) && (
                                  <p className="text-sm text-slate-300 flex items-center">
                                    <span className="w-2 h-2 rounded-full bg-[#db2777] mr-2"></span>
                    ...
                    <Bar dataKey="Cabinets" name="Cabinets" fill="#9333ea" radius={[4, 4, 0, 0]}>
                      <LabelList dataKey="Cabinets" position="top" fill="#fff" fontSize={10} />
                    </Bar>
                    <Bar dataKey="Files" name="Files" fill="#10b981" radius={[4, 4, 0, 0]}>
                      <LabelList dataKey="Files" position="top" fill="#fff" fontSize={10} />
                    </Bar>
                    <Bar dataKey="Folders" name="Folders" fill="#d97706" radius={[4, 4, 0, 0]}>
                      <LabelList dataKey="Folders" position="top" fill="#fff" fontSize={10} />
                    </Bar>
                    <Bar dataKey="Boxes" name="Boxes" fill="#db2777" radius={[4, 4, 0, 0]}>
                      <LabelList dataKey="Boxes" position="top" fill="#fff" fontSize={10} />
                    </Bar>
                  </BarChart>
                </ResponsiveContainer>
              </div>
